package org.xjy.jadmin.generator;
...
public class MyGenerator {
    ...
    public static void gen() {
        ...
        String baseModelPackageName = "org.xjy.jadmin.model.base";
        String baseModelOutputDir = PathKit.getWebRootPath() + "/db/generator/model/base/";
        String modelPackageName = "org.xjy.jadmin.model";
        String modelOutputDir = PathKit.getWebRootPath() + "/db/generator/model/";
        String mappingKitPackageName = "org.xjy.jadmin.model";
