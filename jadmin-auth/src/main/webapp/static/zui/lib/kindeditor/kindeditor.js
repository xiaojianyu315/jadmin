...
KindEditor.plugin('org.xjy.tag.staticsource.zui.lib.kindeditor.plugins.map.map', function(K) {
    var self = this,
        name = 'org.xjy.tag.staticsource.zui.lib.kindeditor.plugins.map.map',
        lang = self.lang(name + '.');
    self.clickToolbar(name, function() {
        var html = ['<div style="padding:10px 20px;">',
            '<div class="ke-dialog-row">',
